        ...
        <div className="py-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href="/success-stories" className="text-gray-600 hover:text-blue-600 transition-colors text-sm">
                  Success Stories
                </a>
              </li>
              <li>
                <a href="/resources" className="text-gray-600 hover:text-blue-600 transition-colors text-sm">
                  Resources
                </a>
              </li>
              <li>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href="/enterprise" className="text-gray-600 hover:text-blue-600 transition-colors text-sm">
                  Enterprise Solutions
                </a>
              </li>
              <li>
                <a href="/customer-success" className="text-gray-600 hover:text-blue-600 transition-colors text-sm">
                  Customer Success
                </a>
              </li>
            </ul>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href="/partnerships" className="text-gray-600 hover:text-blue-600 transition-colors text-sm">
                  Partnerships
                </a>
              </li>
              <li>
